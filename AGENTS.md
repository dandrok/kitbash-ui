...
| Surface | Owns |
|---------|------|
| README | Install, scripts, consume, published version / surface |
...
| docs/TASKS.md | Ordered queue + **phase status** (blog phase done through 0.4.3; optional backlog) |
...
**Blog-driven DS work for this repo is complete at `@ktbsh/ui@0.4.3`.** Prefer consumer integration feedback over inventing optional backlog. Site edits (`astro-blog-md`) need an explicit operator ask (session or AGENTS boundary expansion).
